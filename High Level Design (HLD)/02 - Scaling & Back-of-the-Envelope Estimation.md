...
These notes continue from [Chapter 1](<01 - Introduction, Servers, Deployment & Metrics.md>). Every concept is explained from first principles with real-world analogies, diagrams, and worked examples.

**Previous ←** [Chapter 1: Intro, Servers & Deployment](<01 - Introduction, Servers, Deployment & Metrics.md>) · **Next →** [Chapter 3: CAP Theorem & Database Scaling](<03 - Databases, Replication, Sharding & CAP Theorem.md>)
