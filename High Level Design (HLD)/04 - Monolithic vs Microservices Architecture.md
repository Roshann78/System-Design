...
These notes continue from [Chapter 3 — CAP & Database Scaling](<03 - Databases, Replication, Sharding & CAP Theorem.md>). Every concept is explained from first principles with real-world analogies, diagrams, and worked examples.

**Previous ←** [Chapter 3: CAP & Database Scaling](<03 - Databases, Replication, Sharding & CAP Theorem.md>) · **Next →** [Chapter 5: Caching & Redis](<05 - Caching Strategies & Redis Deep Dive.md>)
