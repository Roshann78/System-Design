...
These notes continue from [Chapter 5 — Caching & Redis](<05 - Caching Strategies & Redis Deep Dive.md>). Every concept is explained from first principles with real-world analogies, diagrams, and worked examples.

**Previous ←** [Chapter 5: Caching & Redis](<05 - Caching Strategies & Redis Deep Dive.md>) · **Next →** [Chapter 7: Kafka Internals & Pub/Sub](<07 - Event-Driven Architecture, Kafka & Real-Time Pub-Sub.md>)
...
| **3** | Event-Driven & Async Brokers | Sync vs async, queues vs Kafka, REST vs broker, when to use which |
